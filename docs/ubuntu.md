...
sudo cp opencode-pool-gateway-0.5.0-linux-amd64 /opt/opencode-pool-gateway/opencode-pool-gateway
...
ARM64 服务器将文件名替换为 `opencode-pool-gateway-0.5.0-linux-arm64`。
